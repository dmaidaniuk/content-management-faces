...
public class NamespacePage {
    ...
    public void addNamespace(String namespaceName) {
        SeleniumUtils.findButtonByName(webDriver, "New Namespace ...").click(); SeleniumUtils.pause(500);
        SeleniumUtils.findInputById(webDriver, "namespaceName").sendKeys(namespaceName); SeleniumUtils.pause(500);
        SeleniumUtils.findButtonByName(webDriver, "Save").click(); SeleniumUtils.pause(500);
    }

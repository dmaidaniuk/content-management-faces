...
CREATE TABLE groupPermissionses (
    id bigint NOT NULL primary key,
...
CREATE TABLE user_to_group (
	...
	foreign key (group_id) references groupPermissionses(id),
	constraint user_group_constraint unique(user_id, group_id)
)

create table permission_group_to_namespace (
    id bigint NOT NULL primary key,
    id permission_group_id NOT NULL,
    id namespace_id NOT NULL,
	foreign key (group_id) references groupPermissionses(id),
	foreign key (namespace_id) references users(id)
)

create table permission_group_to_content (
    id bigint NOT NULL primary key,
    id permission_group_id NOT NULL,
...
create table permission_group_to_style (
    id bigint NOT NULL primary key,
    id permission_group_id NOT NULL,
